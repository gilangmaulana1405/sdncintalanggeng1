                  ...
                  <div class="modal-body">
                      <div class="row">
                          <div class="col-md-6 form-group">
                              ...
                              <input type="text" name="txtNama_lengkap" class="form-control" id="nama_lengkap" required>
                          </div>
                          <div class="col-md-6 form-group">
                              <label for="nama lengkap" class="form-label">Jenis Kelamin</label>
                              <input type="text" name="txtJenis_kelamin" class="form-control" id="nama_lengkap" required>
                          </div>
                          <div class="col-md-6 form-group">
                              <label for="nama lengkap" class="form-label">Tempat Lahir</label>
                              <input type="text" name="txtTempatLahir" class="form-control" id="nama_lengkap" required>
                          </div>
                          <div class="col-md-6 form-group">
                              <label for="nama lengkap" class="form-label">Tanggal Lahir</label>
                              <input type="text" name="txtTanggalLahir" class="form-control" id="nama_lengkap" required>
                          </div>
                          <div class="col-md-6 form-group">
                              <label for="nama lengkap" class="form-label">Agama</label>
                              <input type="text" name="txtAgama" class="form-control" id="nama_lengkap" required>
                          </div>
                          <div class="col-md-6 form-group">
                              <label for="nama lengkap" class="form-label">Kewarganegaraan</label>
                              <input type="text" name="txtKewarganegaraan" class="form-control" id="nama_lengkap" required>
                          </div>
                          <div class="col-md-6 form-group">
                              <label for="nama lengkap" class="form-label">Anak ke</label>
                              <input type="numeric" name="intAnakKe" class="form-control" id="nama_lengkap" required>
                          </div>
                          <div class="col-md-6 form-group">
                              <label for="nama lengkap" class="form-label">Jumlah Saudara</label>
                              <input type="numeric" name="intJumlahSaudara" class="form-control" id="nama_lengkap" required>
                          </div>
                          <div class="col-md-6 form-group">
                              <label for="nama lengkap" class="form-label">Bahasa Sehari-hari</label>
                              <input type="text" name="txtBahasa" class="form-control" id="nama_lengkap" required>
                          </div>
                          <div class="col-md-6 form-group">
                              <label for="nama lengkap" class="form-label">No Telpon</label>
                              <input type="text" name="intNo_telp" class="form-control" id="nama_lengkap" required>
                          </div>
                      </div>
                      <div class="form-group mt-3">
                          <label for="nama lengkap" class="form-label">Alamat</label>
                          <textarea class="form-control" name="txtAlamat" rows="5" required></textarea>
                      </div>
                  </div>
